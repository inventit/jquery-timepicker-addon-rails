...
$.datepicker._gotoToday = function(id) {
  ...
  var tp_inst = this._getInst($(id)[0]);
  var amount = tp_inst.settings.todayMinuteAmount ? tp_inst.settings.todayMinuteAmount * 60 * 1000 : 0;
  this._setTime(tp_inst, new Date(new Date().getTime() + amount));
};
